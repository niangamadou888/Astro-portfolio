  ...
  const webProjects: Project[] = [
    {
      title: "Ytchap",
      description: {
        en: "A platform that enhances YouTube video navigation by enabling creators to divide their content into chapters, making it easier for viewers to access specific sections.",
        fr: "Une plateforme qui améliore la navigation des vidéos YouTube en permettant aux créateurs de diviser leur contenu en chapitres, facilitant l’accès aux sections spécifiques.",
      },
      image: "/ytchap.png",
    ...
    },
    {
      ...
      description: {
        en: "A web tool that analyzes text patterns to determine whether content was written by a human or generated by AI, using advanced natural language processing.",
        fr: "Un outil web qui analyse les modèles de texte pour déterminer si le contenu a été rédigé par un humain ou généré par une IA, à l’aide de techniques avancées de traitement du langage.",
      },
    ...
    },
    {
      title: "Glowlikes",
      description: {
        en: "GlowyViews is a multi-platform social media service that helps users purchase social engagement metrics like followers, likes, and views. The platform supports various social networks including Instagram, Facebook, TikTok, Twitter/X, LinkedIn, YouTube, Spotify, and Telegram.",
        fr: "GlowyViews est un service multi‑plateforme de réseaux sociaux qui aide les utilisateurs à acheter des métriques d’engagement comme des abonnés, des mentions J’aime et des vues. La plateforme prend en charge Instagram, Facebook, TikTok, Twitter/X, LinkedIn, YouTube, Spotify et Telegram.",
      },
      image: "/glowlikes.png",
    ...
    },
    {
      title: "Budget App",
      description: {
        en: "A React-based budget management application with local storage integration for tracking personal finances.",
        fr: "Une application de gestion de budget en React avec stockage local pour suivre les finances personnelles.",
      },
      image: "/budgetapp.png",
